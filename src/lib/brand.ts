export const PLATFORM_NAME = "RUTINA";
export const PLATFORM_BASIC_NAME = `${PLATFORM_NAME} Basic`;
export const PLATFORM_AI_PRO_NAME = `${PLATFORM_NAME} AI Pro`;
/** @deprecated Use PLATFORM_AI_PRO_NAME */
