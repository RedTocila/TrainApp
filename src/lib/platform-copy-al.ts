...
export const platformCopyAl = {
  ...
  profile: {
    ...
    legalHint: "Si i trajtojmë të dhënat dhe rregullat e llogarisë",
    deleteAccount: "Fshi llogarinë",
    deleteAccountHint: "Hiq përgjithmonë hyrjen dhe të gjitha të dhënat. Nuk kthehet mbrapsht.",
    deleteAccountTitle: "Të fshihet llogaria?",
    deleteAccountDescription:
      "Zhduket gjithçka — stërvitje, ushqime, progres, aksesi i abonimit. Pa kthim.",
    deleteAccountTypeLabel: "Shkruaje saktësisht për të konfirmuar:",
    deleteAccountPhrase: "JAP DOREHEQJE!",
    deleteAccountPlaceholder: "JAP DOREHEQJE!",
    deleteAccountConfirm: "Fshi përgjithmonë",
    deleteAccountDeleting: "Duke fshirë…",
    deleteAccountMismatch: "Shkruaje frazën saktësisht siç duket, me shkronja kapitale.",
    deleteAccountFailed: "Nuk u fshi llogaria. Provo përsëri.",
  },
  referral: {
    title: "Fto miq",
    subtitle: "Ndaj kodin, fito kredi, hyr në flash challenges",
    navAria: "Referimet",
    profileCardTitle: "Referimet",
    profileCardHint: "Fto miq dhe ruaj kredi €10",
    open: "Hap referimet",
    yourCode: "Kodi yt",
    copyCode: "Kopjo kodin",
    copied: "U kopjua",
    shareLink: "Ndaj linkun",
    balance: "Bilanci i kredive",
    earned: "Të fituara",
    saved: "Të kursyera me kredi",
    invites: "Ftesa të suksesshme",
    ...
    alreadyReferred: "Një referim është tashmë i lidhur me llogarinë tënde.",
    ...
    creditsApplied: (amount: string) => `${amount} kredi të aplikuara`,
    payWithCredits: "Paguaj me kredi",
    payRemainder: (amount: string) => `Paguaj ${amount}`,
    history: "Aktiviteti",
    emptyHistory: "Ende pa aktivitet referimi.",
    earnTx: "Shpërblim referimi — miku u abonua",
    spendTx: "Kredi të përdorura në checkout",
    flashSpendTx: "Kredi të përdorura për hyrje në flash challenge",
  },
  subscription: {
  ...
  reminders: {
    title: "Njoftimet & kujtesat",
    subtitle:
      "Merr një kujtesë kur stërvitja, vaktet, kardio, uji ose zakonet e sotme janë ende hapur.",
    masterLabel: "Aktivizo kujtesat",
    masterHint:
      "Dërgohet vetëm nëse ajo gjë është ende e papërfunduar në orën e kujtesës.",
    nativeOnlyHint:
      "Kujtesat dërgohen në aplikacionin RUTINA (iOS/Android). Cilësimet ruhen këtu për kur e përdor aplikacionin.",
    permissionDenied:
      "Leja për njoftime është e fikur. Aktivizoje te cilësimet e sistemit.",
    ...
    types: {
      workout: "Stërvitja",
      meals: "Vaktet e regjistruara",
      cardio: "Kardio",
      water: "Pi ujë",
      habits: "Zakonet ditore",
    },
    typeHints: {
      workout: "Nëse stërvitja e sotme është ende e hapur",
      meals: "Nëse nuk ke regjistruar asnjë vakt",
      cardio: "Nëse kardio e planifikuar nuk është bërë",
      water: "Nëse je nën objektivin e ujit",
      habits: "Nëse ndonjë zakon i sotëm është ende hapur",
    },
    notifTitles: {
      workout: "Stërvitja ende hapur",
      meals: "Vaktet pa u regjistruar",
      cardio: "Kardio në pritje",
      water: "Objektivi i ujit",
      habits: "Zakone të papërfunduara",
    },
    notifBodies: {
      workout: "Ke ende një stërvitje për të përfunduar sot.",
      meals: "Regjistro vaktet për të qëndruar në rrugën e duhur sot.",
      cardio: "Seanca jote e kardios është ende në pritje.",
      water: "Je nën objektivin e ujit — pi një gotë.",
      habits: "Disa zakone ditore janë ende të hapura.",
    },
  },
  goals: {
  ...
  dashboard: {
    nutrition: "Ushqimi",
    todaysWorkout: "Stërvitja e ditës",
  ...
  common: {
    ...
    loadingDay: "Duke ngarkuar ditën",
  },
  aria: {
    completed: "E përfunduar",
    close: "Mbyll",
  ...
  workout: {
    ...
    preview: "Si bëhet",
    howToDo: "Si ta bësh",
    coachTip: "Këshilla e coach-it",
    noInstructions: "Nuk ka ende udhëzime hap-pas-hapi për këtë ushtrim.",
    ...
    repsRequired: "Përsëritjet e kërkuara",
    rest: "Pushim",
    setsDone: "Seri të bëra",
    work: "Punë",
    roundsLeft: "Raunde të mbetura",
    cyclesLeft: "Cikle të mbetura",
    exerciseProgress: (current: number, total: number) => `${current}/${total}`,
    nextExercise: "Tjetër",
    previousExercise: "Mëparshëm",
    logSet: "Regjistro serinë",
    ...
    neverTried: "Nuk e ke provuar këtë më parë",
    myWorkoutSchedule: "Orari im",
    myWorkout: "Orari im",
    weekPlansTitle: "Planet",
    weekPlansEmpty: "Nuk ka ende plane javore",
    weekPlansEmptyHint:
      "Një plan është një javë e plotë stërvitjeje — p.sh. e hënë gjoks, e martë shpinë, e enjte këmbë — me ngrohje dhe shtrirje. Ndërtoje nga stërvitjet e tua, ose pyete Coach Alex.",
    weekPlanCreate: "Krijo plan",
    weekPlanEdit: "Ndrysho planin",
    weekPlanCreateHint: "Zgjidh stërvitjet dhe caktoji ditëve të javës.",
    weekPlanDays: (n: number) => `${n} ditë stërvitje`,
    weekPlanSchedule: "Planifiko planin",
    weekPlanScheduling: "Po planifikohet…",
    weekPlanScheduleWeeks: "Sa javë?",
    weekPlanWeeksLabel: "Javë",
    weekPlanScheduled: (n: number, weeks: number) =>
      `U planifikuan ${n} seanca në ${weeks} javë.`,
    weekPlanScheduledButton: "I planifikuar",
    weekPlanSaveSchedule: "Ruaj ndryshimet",
    weekPlanSavingSchedule: "Po ruhet…",
    weekPlanPreview: "Parapamja e planit",
    weekPlanPreviewHint: "Trokit një stërvitje për të parë ushtrimet.",
    weekPlanPreviewEmpty: "Nuk ka ende stërvitje në këtë plan.",
    weekPlanPreviewNoExercises: "Kjo stërvitje nuk ka ende ushtrime.",
    weekPlanDelete: "Fshi",
    weekPlanWeekday: {
      mon: "E hënë",
      tue: "E martë",
    ...
    weekPlanBuilderTitle: "Emri i planit",
    weekPlanBuilderTitlePlaceholder: "p.sh. Hipertrofi · 4 ditë palestrë",
    weekPlanBuilderDescription: "Përshkrimi (opsional)",
    weekPlanBuilderDescriptionPlaceholder: "Shënim i shkurtër për këtë javë",
    weekPlanBuilderIncludeExtras: "Përfshi ngrohje + shtrirje çdo ditë stërvitjeje",
    weekPlanBuilderWarmup: "Ngrohje",
    weekPlanBuilderStretch: "Shtrirje",
    weekPlanBuilderOptional: "Asnjë",
    weekPlanBuilderNoExtras: "Nuk ka ngrohje/shtrirje të përputhura",
    weekPlanBuilderAutoPick: (name: string) => `Automatikisht: ${name}`,
    weekPlanBuilderDays: "Ditët e stërvitjes",
    weekPlanBuilderDaysHint:
      "Aktivizo ditët që stërvitesh, pastaj zgjidh një stërvitje. Ngrohja dhe shtrirja përputhen automatikisht.",
    weekPlanBuilderPickWorkout: "Stërvitja",
    weekPlanBuilderPickWorkoutHint:
      "E njëjta listë si Stërvitjet — zgjidh një kartë për këtë ditë.",
    weekPlanBuilderChooseWorkout: "Zgjidh stërvitjen",
    weekPlanBuilderChangeWorkout: "Ndrysho stërvitjen",
    weekPlanBuilderPickDay: "Dita në stërvitje",
    weekPlanBuilderFocus: "Fokusi",
    weekPlanBuilderFocusPlaceholder: "p.sh. Push, Legs, Core",
    weekPlanBuilderSave: "Ruaj planin",
    weekPlanBuilderSaving: "Po ruhet…",
    weekPlanBuilderNoWorkouts: "Nuk ka ende stërvitje për të përdorur",
    weekPlanBuilderNoWorkoutsHint:
      "Ndërto fillimisht një stërvitje, pastaj kthehu për të rregulluar javën.",
    scheduleWeek: (n: number) => `Java ${n}`,
    scheduleRestDay: "Pushim — asgjë e planifikuar",
    previous: "Mëparshëm",
    ...
    doStretch: "Bëj shtrirjen",
    skipStretch: "Anashkalo shtrirjen",
    skipToStretch: "Kalo te shtrirja",
    skipSession: "Anashkalo këtë seancë",
    skipExercise: "Anashkalo ushtrimin",
    sessionSkipped: "Anashkaluar",
    dayFlowYouAreHere: "Je këtu",
    dayFlowStepOf: (step: number, total: number) => `Hapi ${step} nga ${total}`,
    getReadyFor: "Përgatitu",
    dayPlanTitle: "Plani i sotëm",
    dayPlanHint: "Ngrohje, stërvitja kryesore, pastaj shtrirje — mund të anashkalosh çdo hap.",
    viewDayPlan: "Shiko planin",
    kcalEstimate: (n: number) => `${n} kcal`,
    muscleGroups: {
      arms: "Krahë",
      shoulders: "Shpatulla",
      chest: "Gjoks",
    ...
    openDayCalendar: "Hap stërvitjen e ditës",
  ...
  cardio: {
    ...
    startCardio: "Fillo",
    continueCardio: "Vazhdo",
    startSession: "Fillo kardion",
    pause: "Pauzë",
    resume: "Vazhdo",
    finish: "Përfundo",
    ...
    finishSummaryTitle: "Përmbledhje seance",
    noCardioForDay: "Nuk ka kardio të planifikuar për këtë ditë.",
    alreadyCompleted: "Kjo kardio është tashmë e përfunduar.",
    needMoreTime: (needed: string) =>
      `Vazhdo — nevojiten të paktën edhe ${needed} për ta përfunduar (tolerancë 20%).`,
    tooShortToComplete: "Shumë e shkurtër për ta shënuar si të përfunduar.",
    types: {
      treadmill: "Treadmill",
  ...
  habits: {
    ...
    editHabit: "Ndrysho zakonin",
    formHint:
      "Vendos emrin, orarin e përsëritjes dhe një dritare opsionale kohe. Lini orët bosh për zakone gjatë gjithë ditës.",
    habitName: "Emri i zakonit",
    habitNamePlaceholder: "p.sh. Stretching i mëngjesit",
    fromOptional: "Nga (opsionale)",
    untilOptional: "Deri (opsionale)",
  },
  weight: {
    title: "Pesha trupore",
  ...
  photos: {
    ...
    readMeBody: [
      "Çdo muaj ngarko foto përpara, prapa dhe anash të vetes. Kamera hapet fillimisht — prek Snapshot për foto live, ose Nga galeria për të zgjedhur një ekzistuese.",
      "Preferoni Snapshot live kur të mundeni. Fotot nga galeria lejohen, por duhet të jenë foto të sinqerta të juaja në pozën e duhur.",
      ...
      "Gjinia e gabuar, një person tjetër ose poza e gabuar mund të refuzohen. E përdorët gabimisht dikë tjetër në foton e parë? Kontaktoni suportin për ta rivendosur.",
    ],
    ...
    captureHint: "Bëni Snapshot me kamerën, ose zgjidhni Nga galeria.",
    fromGallery: "Nga galeria",
    snapshot: "Snapshot",
    startingCamera: "Kamera po hapet…",
    cameraUnavailable: "Kamera nuk është e disponueshme. Kontrolloni lejet dhe provoni përsëri.",
    useGalleryInstead: "Mund të zgjidhni ende një foto Nga galeria.",
    replace: "Zëvendëso",
    retake: "Ribëj",
    deletePhoto: "Fshi",
    ...
    monthIncomplete: "Muaji i paplotësuar",
    overdueFinish: "Me vonesë — përfundo fotot",
    dueTodayFinish: "Afati sot — përfundo fotot",
    oneDayLeft: "1 ditë e mbetur për të përfunduar fotot",
    daysLeft: (n: number) => `${n} ditë të mbetura për të përfunduar fotot`,
    nextOverdue: (due: string) => `Fotot e ardhshme me vonesë · afati ${due}`,
    nextDueToday: (due: string) => `Fotot e ardhshme sot · ${due}`,
    nextInOneDay: (due: string) => `Fotot e ardhshme pas 1 dite · ${due}`,
    nextInDays: (n: number, due: string) =>
      `Fotot e ardhshme pas ${n} ditësh · ${due}`,
    previousPhoto: "Fotoja e mëparshme",
    nextPhoto: "Fotoja e ardhshme",
  },
  trainer: {
  ...
  ai: {
    ...
    placeholder: "Pyete Alex…",
    placeholderAsk: "Pyete Alex…",
    ...
    voiceStopAria: "Ndalo hyrjen me zë",
    voiceListening: "Duke dëgjuar…",
    voiceRecording: "Duke regjistruar…",
    voiceTranscribing: "Duke transkriptuar…",
    ...
    buildWorkoutWithAiDesc: "Plan stërvitjeje i personalizuar sipas qëllimit dhe nivelit tënd",
    buildNutritionWithAi: "Krijo plan ushqimi me AI",
    buildNutritionWithAiDesc: "Plan ushqimi i personalizuar sipas preferencave të tua",
    createPrivacyNote: "Të dhënat e tua janë private dhe të sigurta",
    hello: (name: string) => (name ? `Përshëndetje ${name}! 👋` : "Përshëndetje! 👋"),
    hereForYou: "Unë jam këtu për ty",
    howCanIHelp: "Si mund të të ndihmoj sot?",
    progressThisWeek: "Progresi javor",
    seeMore: "Shiko më shumë",
    tipOfTheDay: "Këshilla e ditës",
    tipFallback: "Konsistenca është ajo që transformon objektivat në rezultate.",
    faqsTitle: "Pyetje të shpeshta",
    weekDayLabels: ["H", "M", "M", "E", "P", "SH", "D"] as const,
    currentChallenge: "Challenge aktual",
    yourProgress: "Progresi yt",
    yourRank: "Renditja jote",
    challengeParticipants: "Pjesëmarrës",
    noActiveChallenge: "Nuk ke challenge aktiv",
    browseChallenges: "Shiko challenges",
    quickTopics: [
      { id: "motivation", label: "Motivim", prompt: "Më jep një motivim të shkurtër për stërvitjen e sotme." },
      { id: "training", label: "Stërvitje", prompt: "Më ndihmo me stërvitjen — ku duhet të fokusohem sot?" },
      { id: "food", label: "Ushqim", prompt: "Më jep këshilla praktike ushqimi për qëllimin tim sot." },
      { id: "recovery", label: "Rikuperim", prompt: "Si duhet të rikuperohem sot që të performoj më mirë nesër?" },
    ],
    helpTiles: {
      progress: { label: "Progresi yt", desc: "Trende dhe parashikime" },
      tips: { label: "Këshilla & tips", desc: "Këshilla ditore coachingu" },
      weeklyReport: { label: "Raporti javor", desc: "Rezultate dhe përmbledhje" },
      mealIdeas: { label: "Ide vaktesh", desc: "Sugjerime të zgjuara ushqimi" },
    },
    faqItems: [
      {
      ...
      },
      {
        ...
        prompt: "Si mund të ndërtoj muskuj më shpejt me stërvitjen dhe ushqimin tim aktual?",
      },
      {
        question: "Sa gjumë më duhet për rikuperim?",
        prompt: "Sa gjumë më duhet për rikuperim dhe çfarë duhet të ndryshoj sonte?",
      },
      {
        question: "A më duhen suplementet për qëllimin tim?",
        prompt: "A më duhen suplementet për qëllimin tim dhe cilat vlejnë vërtet?",
      },
    ],
    flowProfile: "Profili",
    ...
    workoutsThisWeek: "Stërvitje",
    daysTracked: "Ditë radhazi",
    training: "Stërvitje",
    nutrition: "Ushqim",
  ...
  calendar: {
    ...
    daySummary: (active: number, completed: number, missed: number) =>
      missed > 0
        ? `${active} aktive · ${completed} të përfunduara · ${missed} të humbura`
        : `${active} aktive · ${completed} të përfunduara`,
    dailyOverview: "Përmbledhja jote ditore",
    overviewFor: (date: string) => `Përmbledhje për ${date}`,
    today: "Sot",
    tomorrow: "Nesër",
    tomorrowShort: "Nsr",
    done: "kryer",
    tasksCount: (n: number) => `${n} detyrë${n === 1 ? "" : "a"}`,
    noTasks: "Pa detyra",
    moreTasks: (n: number) => `+${n} të tjera`,
    allTasksCompleted: "Të gjitha detyrat të përfunduara",
    tasksIncomplete: "Detyra të papërfunduara",
    tasksCompletedAria: (done: number, total: number) =>
      `${done} nga ${total} detyra të përfunduara`,
    tasksFor: (date: string) => `Detyrat për ${date}`,
  },
  support: {
    needHelp: "Ke nevojë për ndihmë?",
    helpBlurb: "Për çdo problem, telefononi ose shkruani në WhatsApp.",
    call: "Telefono",
    whatsapp: "WhatsApp",
    contactSupport: "Kontakto supportin",
  },
  schedule: {
    startingToday: (date: string) => `Fillo sot (${date})`,
    startingNextWeek: (date: string) => `Fillo javën tjetër (${date})`,
    selectDayAndWeek: "Zgjidh të paktën një ditë dhe një javë.",
    selectAtLeastOneDay: "Zgjidh të paktën një ditë",
    sessionRange: (count: number, first: string, last: string) =>
      `${count} seancë${count === 1 ? "" : " seanca"} · ${first} – ${last}`,
  },
  pricing: {
  ...
  bmi: {
    ...
    colorMapTitle: "Kategoritë e BMI",
    yourWeightIs: "Pesha jote është",
    basedOn: (weight: string, height: string | null) =>
      height
        ? `Bazuar në ${weight} dhe lartësinë ${height}.`
        : `Bazuar në ${weight}.`,
    lastLogged: (date: string) => `Regjistruar së fundmi ${date}.`,
    usingIntakeWeight: "Duke përdorur peshën e intake.",
  ...
  mealLog: {
    ...
    startingCamera: "Kamera po hapet…",
    cameraUnavailable: "Kamera nuk u hap. Kontrollo lejet dhe provo përsëri.",
    useGalleryInstead: "Mund të zgjedhësh ende një foto nga galeria.",
    barcodeScanFailed: "Skanimi i barkodit dështoi. Provo përsëri.",
    barcodeNotFound: "Nuk u gjet produkt për këtë barkod. Provo një tjetër.",
    barcodeLookupFailed: "Barkodi nuk u kërkua. Provo përsëri.",
    preparingPhoto: "Duke përgatitur foton…",
    analyzingMeal: "Duke analizuar vaktin…",
    lookingUpBarcode: "Duke kërkuar produktin…",
    ...
    retakePhoto: "Ribëj foton",
    alexNotFoodTitle: "Kjo nuk është vakt",
  ...
  challenges: {
    ...
    catalog: {
      ...
      registrationProgress: "Regjistrimi",
      participantsLabel: "Pjesëmarrës",
      spotsLeftLabel: "Vende të lira",
      prizePoolLabel: "Prize pool",
      prizePoolUpTo: (amount: string) => `Mund të shkojë deri në ${amount}`,
    ...
    join: {
      ...
      inactiveNotOpen: "Kjo sfidë nuk është hapur ende. Kontrollo përsëri së shpejti.",
    },
  },
  platformScore: {
