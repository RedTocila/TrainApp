        ...
        <div className="dashboard-shell flex min-h-0 overflow-hidden bg-background">
          ...
          <FullCalendarProvider>
            <div className="relative flex min-h-0 min-w-0 flex-1 flex-col">
              <main
                className="dashboard-main min-h-0 min-w-0 flex-1 overflow-x-hidden overflow-y-auto overscroll-y-none bg-background px-0 pb-[var(--dashboard-mobile-nav-height,4.25rem)] [-webkit-overflow-scrolling:touch] lg:pb-0"
              >
              <DashboardMainArea>
                {children}
              </DashboardMainArea>
