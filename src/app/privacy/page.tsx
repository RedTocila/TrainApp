...
export const metadata: Metadata = {
  title: "Privacy Policy — TrainApp",
  description: "How TrainApp collects, uses, and protects your personal data.",
  ...
  return (
    ...
    >
      <section className="space-y-4">
        <h2>1. Overview</h2>
        <p>
          TrainApp (&quot;we&quot;, &quot;us&quot;) respects your privacy. This policy explains what
      ...
      <section className="space-y-4">
        ...
        <ul>
          <li>Provide and personalize the TrainApp experience.</li>
