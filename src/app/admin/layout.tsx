  ...
  return (
    <div className="app-shell flex h-dvh min-h-0 overflow-hidden bg-background">
      ...
      <div className="relative flex min-h-0 min-w-0 flex-1 flex-col">
        ...
        <main
          className="min-h-0 min-w-0 flex-1 overflow-x-hidden overflow-y-auto overscroll-y-contain bg-background pb-0 pt-[var(--dashboard-mobile-header-height)] [-webkit-overflow-scrolling:touch] lg:pt-0"
        >
