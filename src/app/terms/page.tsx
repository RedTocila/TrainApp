...
export const metadata: Metadata = {
  title: "Terms of Service — TrainApp",
  description: "Terms of Service for TrainApp fitness platform.",
  ...
  return (
    ...
    >
      <section className="space-y-4">
        <h2>1. Agreement</h2>
        <p>
          By creating an account or using TrainApp, you agree to these Terms of
      ...
      <section className="space-y-4">
        ...
        <p>
          TrainApp provides fitness tracking, workout and nutrition tools, AI-powered
      ...
      <section className="space-y-4">
        ...
        <ul>
          ...
          <li>You must be at least 16 years old to use TrainApp.</li>
        </ul>
      </section>
      ...
      <section className="space-y-4">
        ...
        <ul>
          <li>
            Paid plans (TrainApp Core and TrainApp AI) are billed monthly or
      ...
      <section className="space-y-4">
        ...
        <p>
          TrainApp is not a medical service. Content, AI suggestions, and coaching
      ...
      <section className="space-y-4">
        ...
        <p>
          TrainApp, its branding, and platform content are owned by TrainApp or its
      ...
      <section className="space-y-4">
        ...
        <p>
          To the maximum extent permitted by law, TrainApp is provided &quot;as is&quot;
